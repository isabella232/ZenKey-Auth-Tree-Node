 ...
 * @since AM 5.5.0
 */
public class ZenKeyAuthNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(ZenKeyAuthNodePlugin.currentVersion, 
				Collections.singletonList(ZenKeyAuthNode.class));
	}
	...
	public String getPluginVersion() {
		return ZenKeyAuthNodePlugin.currentVersion;
	}
}
